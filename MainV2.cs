...
namespace MissionPlanner
{
    public partial class MainV2 : Form
    {
        ...
        public void updateLayout(object sender, EventArgs e)
        {
            ...
            MenuTerminal.Visible = false; //DisplayConfiguration.displayTerminal;  //菜单终端  add yp
  //        MenuTerminal.Visible = false; //DisplayConfiguration.displayTerminal;
            MenuHelp.Visible = DisplayConfiguration.displayHelp;  //false
            MenuDonate.Visible = false; //DisplayConfiguration.displayDonate;
        ...
        public MainV2()
        {
            ...
            //add z 2020 05 19 下拉框修改为不可输入

            _connectionControl.cmb_sysid.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
            _connectionControl.CMB_serialport.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
            _connectionControl.CMB_baudrate.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
    ...
    System.Windows.Forms.DialogResult.OK)
        ...
        private void MenuArduPilot_Click(object sender, EventArgs e)
        {
            try
            {
                System.Diagnostics.Process.Start("http://www.hmjtx.com/");
            }
            catch
            {
                CustomMessageBox.Show("Failed to open url http://www.hmjtx.com/");
            }
        }
